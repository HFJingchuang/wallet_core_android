...
public class WalletFile {
    ...
    public boolean equals(Object o) {
        ...
        if (getChainType() != null
                ? !getChainType().equals(that.getChainType())
                : that.getChainType() != null) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = 31 * result + getChainType() != null ? getChainType().hashCode() : 0;
    ...
    public static WalletFile parse(String keystore) throws IOException {
        return new ObjectMapper().readValue
                (keystore, WalletFile.class);
    }
