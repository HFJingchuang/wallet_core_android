package com.jch.core.swtc.core.serialized.enums;
...
public enum EngineResult implements SerializedType {
    telLOCAL_ERROR(-399, "Local failure."), telBAD_DOMAIN(-398, "Domain too long."), telBAD_PATH_COUNT(-397,
            ...
            "Malformed: Bad offer."), temBAD_PATH(-290,
            ...
            129,
            "One of _ADD, _OFFER, or _SEND. Deprecated."), tecNO_ALTERNATIVE_KEY(
            130,
            "tecNO_ALTERNATIVE_KEY"), tecNO_REGULAR_KEY(
            131,
            ...
            141,
            "Insufficient reserve to complete requested operation."), tecNEED_MASTER_KEY(
            142,
            "The operation requires the use of the Master Key."), tecDST_TAG_NEEDED(
            143,
            "A destination tag is required."), tecINTERNAL(
            144,
            "An internal error has occurred during processing."), tecOVERSIZE(
            145,
    ...
    @Override
    public String toHex() {
        return Numeric.toHexStringNoPrefix(toBytes()).toUpperCase();
    }
