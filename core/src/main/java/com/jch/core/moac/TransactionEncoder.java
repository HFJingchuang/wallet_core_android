 ...
 */
package com.jch.core.moac;

import com.jch.core.cypto.ChainIdLong;
import com.jch.core.cypto.ECKeyPair;
import com.jch.core.rlp.RlpEncoder;
import com.jch.core.rlp.RlpList;
import com.jch.core.rlp.RlpString;
import com.jch.core.rlp.RlpType;
...
public class TransactionEncoder {
    ...
    public static byte[] signMessage(RawTransaction rawTransaction, ECKeyPair keyPair) {
        ...
        return signMessage(rawTransaction, ChainIdLong.MC_MAINNET, keyPair);
    }

    public static byte[] signMessage(
            RawTransaction rawTransaction, long chainId, ECKeyPair keyPair) {
        byte[] encodedTransaction = encode(rawTransaction, chainId);
        Sign.SignatureData signatureData =
                Sign.signMessage(encodedTransaction, keyPair);
    ...
    @Deprecated
    public static byte[] signMessage(
            RawTransaction rawTransaction, byte chainId, ECKeyPair keyPair) {
        return signMessage(rawTransaction, (long) chainId, keyPair);
    }
    ...
    public static List<RlpType> asRlpValues(
        ...
        // transaction.systemContract = '0x0';
        result.add(RlpString.create(BigInteger.ZERO));// System contract flag, always = 0
