...
public class TransactionUtils {
     ...
     * @param keyPair        of the sender
     * @return encoded transaction hash
     */
    public static byte[] generateTransactionHash(
            RawTransaction rawTransaction, ECKeyPair keyPair) {
    ...
    public static byte[] generateTransactionHash(
        ...
        byte[] signedMessage = TransactionEncoder.signMessage(rawTransaction, chainId, keyPair);
        return Hash.sha3(signedMessage);
    }
    ...
    public static String generateTransactionHashHexEncoded(
            RawTransaction rawTransaction, ECKeyPair keyPair) {
        return Numeric.toHexString(generateTransactionHash(rawTransaction, keyPair));
    }
    ...
    public static String generateTransactionHashHexEncoded(
            RawTransaction rawTransaction, byte chainId, ECKeyPair keyPair) {
        return Numeric.toHexString(generateTransactionHash(rawTransaction, chainId, keyPair));
    }
}
